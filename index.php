...
<body>
  ...
  <div id="myDiv">
    <!--HEADER-->
    <div class="header" background: url('../img/polinema.jpg') no-repeat fixed; background-size: cover; min-height: 650px; position: relative;>
      <div class="bg-color">
          ...
          <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">JTI Polinema</span></a>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="banner-info text-center wow fadeIn delay-05s">
                ...
                <div class="logo">
                  <img src="img/logo.png" width="500" height="300" alt="" />
                </div>
                <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">JURUSAN TEKNOLOGI INFORMASI</span></h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">POLITEKNIK NEGERI MALANG</span></h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Jurusan Teknologi Informasi Politeknik Negeri Malang</p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
            <figure>
              <img src="img/Syalwa.jpeg" width="300" height="100" class="img-responsive">
              <figcaption>
                <h2>Syalwa Naura Rizquna</h2>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; JTI POLINEMA All Rights Reserved.</p>
          <div class="credits">
            <!-- 
