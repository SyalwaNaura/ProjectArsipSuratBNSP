        ...
        <section class="login_content">
          <form action="proses_login.php" id="login" name="login" method="post">
            ...
            <div class="form-group has-feedback">
              <input type="text" id="username" name="username_admin_bagian" class="form-control" autocomplete="off" maxlength="100" placeholder="Username" required="username" />
              <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
              <input type="password" id="password" name="password_bagian" class="form-control" autocomplete="off" maxlength="100" placeholder="Password" required="password" />
            ...
            <div class="separator">
              <div>
                <h2><i class="fa fa-institution"></i> JTI POLINEMA</h2>
                <p>©2021 POLINEMA</p>
              </div>
            </div>
          </form>
